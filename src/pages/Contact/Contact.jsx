            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300 text-lg">
                  The form is currently not functioning properly, but if you
                  help me build it, I will develop both the backend using
                  Node.js and the frontend using React.js for you.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">kailashrajut0575@gmail.com</p>
                  </div>
                </div>
